...
class Categorias extends Component {
    ...
    constructor(){
        ...
        this.state = {
            url : 'https://5f9303028742070016da64a7.mockapi.io/api/categorias',
            id : '',
            nome : '',
            categorias : []
        }
    ...
    render() {
        return (
            <div>
                <Menu />
                <Jumbotron titulo='Categorias' descricao='Crie suas categorias' />
                <div className="container">
                    <div className="bd-example">
                        <form id="formCategoria" onSubmit={this.salvar.bind(this)}>
                            <div className="form-group">
                                <label htmlFor="nome">Nome</label>
                                <input type="text" className="form-control" value={this.state.nome} onChange={this.setNome.bind(this)} id="nome" aria-describedby="nome" placeholder="Insira a categoria" />
                            </div>
                            <button type="button" onClick={this.categoriaNova.bind(this)} className="btn btn-secondary">Cancelar</button>
                        ...
                        <table className="table" style={{marginTop : '40px'}}>
                            ...
                            <tr>
                                ...
                                <th scope="col"><button type="reset" className="btn btn-primary" onClick={this.categoriaNova.bind(this)}>Nova Categoria</button></th>
                            </tr>
                            </thead>
